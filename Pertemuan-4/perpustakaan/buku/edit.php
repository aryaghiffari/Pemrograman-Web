...
if (isset($_POST["submitted"])==1 && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dat = $obj->updateBuku($id,$kode_buku,$judul,$kode_kategori,$pengarang);
    $msg = getJSON($dat);
}
$rows = $obj->getBuku($id);
?>
                            ...
                            <div class="panel panel-default">
                                ...
                                ?>
                                            ...
                                            <form name="formEdit" method="POST" action="">
                                                ...
                                                <div class="form-group">
                                                    <label>kode_kategori:</label>
                                                    <select id="kode_kategori" name="kode_kategori" style="width:150px" 
                                                    class="form-control show-tick" required>

                                                    <option value="<?php echo $row['kode_kategori']; ?>">
                                                    <?php echo $row['kode_kategori']; ?></option>
                                                      <option value="01_Fiksi">01_Fiksi</option>
                                                      <option value="a02_Karya-Ilmiah">02_Karya-Ilmiah</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
