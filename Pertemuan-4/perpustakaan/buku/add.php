...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dat = $obj->addBuku($kode_buku,$judul,$kode_kategori,$pengarang);
    $msg = getJSON($dat);
}
                                ...
                                ?>
                                            ...
                                            <form name="formAdd" method="POST" action="">
                                                ...
                                                <label>kode_kategori:</label>
                                                    <select id="kode_kategori" name="kode_kategori" style="width:150px" class="form-control">

                                                       <option value="">--pilih--</option>
                                                       <option value="01_Fiksi">01_Fiksi</option>
                                                       <option value="02_Karya-Ilmiah">02_Karya-Ilmiah</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
